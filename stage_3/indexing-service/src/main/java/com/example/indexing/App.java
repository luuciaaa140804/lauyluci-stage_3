...
// Note: avoid importing com.hazelcast.internal.nio.Connection which clashes with java.sql.Connection
...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Connection connection = (Connection) ((ActiveMQConnectionFactory) factory).createConnection();
        ((ActiveMQConnectionFactory) connection).setClientID(nodeId);
        ((javax.jms.Connection) connection).start();
        try (Session session = ((javax.jms.Connection) connection).createSession(false, Session.AUTO_ACKNOWLEDGE)) {
    ...
    private static void initDatabase(String dbPath) throws SQLException, IOException {
